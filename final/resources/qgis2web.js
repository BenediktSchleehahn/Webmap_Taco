...
map.getView().fit([2311797.458379, 8411752.905022, 2524640.080748, 8579143.091497], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Disturbance of the Eider Population due to human acitivity </h2>';
        return titleElement;
    })(),
